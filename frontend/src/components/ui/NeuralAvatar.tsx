...
export const NeuralAvatar: React.FC<NeuralAvatarProps> = ({
    ...
    return (
        <div className={cn("relative flex items-center justify-center", sizeClasses[size], className)}>
            {/* Core */}
            <motion.div
                className="absolute inset-[25%] rounded-full z-10 box-shadow-glow flex items-center justify-center overflow-hidden bg-white/10"
                animate={{
            ...
            >
                {src ? (
                    ...
                    <div className="w-[40%] h-[40%] bg-white rounded-full shadow-lg" />
                )}
            </motion.div>
